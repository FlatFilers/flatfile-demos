...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/flatfile-csv-importer/build/browser/index.js":[function(require,module,exports) {
...
function ElementClass(opts) {
  ...
  var self = this;
  if (!opts) opts = {}; // similar doing instanceof HTMLElement but works in IE8
    ...
    var promise = new Penpal.Promise(function (resolve, reject) {
      ...
      var handleMessage = function handleMessage(event) {
        if (event.source === child && event.origin === childOrigin && event.data.penpal === HANDSHAKE) {
          ...
          connectCallReceiver(info, methods, destructionPromise); // If we're reconnecting, remove methods from the previous connection.
...
var FlatfileResults = function () {
  ...
  Object.defineProperty(FlatfileResults.prototype, "validData", {
     ...
     */
    get: function () {
      var res = this.$data.filter(function (v) {
        return v.valid;
      }).filter(function (v) {
        return !v.deleted;
      }).map(function (v) {
  ...
  Object.defineProperty(FlatfileResults.prototype, "allData", {
     ...
     */
    get: function () {
      return this.blobOnly(this.$data.map(function (v) {
        return v.data;
      }), 'allData');
    },
    enumerable: true,
...
var FlatfileImporter = function (_super) {
  ...
  FlatfileImporter.prototype.open = function (options) {
    ...
    options = __assign({}, options, {
      ...
      fieldHooks: this.$fieldHooks.map(function (v) {
        return v.field;
      }),
  ...
  FlatfileImporter.prototype.requestDataFromUser = function (options) {
    ...
    this.open(__assign({}, options, {
      inChunks: options.inChunks || null,
      expectsExpandedResults: true
    }));
    ...
    this.handshake = Penpal.connectToChild({
      ...
      methods: {
        ...
        fieldHookCallback: function (values, meta) {
          var fieldHook = _this.$fieldHooks.find(function (v) {
            return v.field === meta.field;
          });
  ...
  FlatfileImporter.prototype.responsePromise = function () {
    ...
    return new Promise(function (resolve, reject) {
      var loadResolveHandler = function (rows, meta) {
...
},{"process":"node_modules/process/browser.js"}],"src/numbers.js":[function(require,module,exports) {
"use strict";
...
exports.makeFloat = void 0;

var _numbers = require("./numbers");

var makeFloat = function makeFloat(value) {
  var returnValue = value.split("").filter(function (item) {
    return _numbers.numbers.includes(item);
  });
...
},{"./numbers":"src/numbers.js"}],"src/translations.js":[function(require,module,exports) {
"use strict";
...
var translations = {
  ...
  clearAndClose: "Are you sure you want to close the importer and clear all data?",
  ...
  dropzone: {
    ...
    description: "You can upload any {{file}} file with any set of columns as long as it has 1 record per row. The next step will allow you to match your spreadsheet columns to the right data points. You'll be able to clean up or remove any corrupted data before finalizing your report."
  },
  errors: {
    anomolies: "The CSV-to-JSON parser tracked some anomalies in your CSV file. The errors were not fatal, but you can review them below and choose to edit them before including them in your data set, or you can choose to ignore them and they will be skipped.",
    dupHeaders: "There are duplicate headers: {{headers}}. Please fix and upload again.",
    error: "Errors: {{errors}}",
    fileReader: "FileReader is not supported in this browser.",
    maxRecords: "The maximum number of rows we accept is {{maxRecords}}. Consider breaking your file into multiple parts.",
    notSupported: "This file type is not supported.",
    parsing: "Parsing errors",
    unreadable: "Cannot read file!",
    unresolvedFormat: "You have {{errorCount}} rows with unresolved format issues."
  },
  fileTypes: "You can upload any {{fileTypes}} file with any set of columns as long as it has 1 record per row. The next step will allow you to match your spreadsheet columns to the right data points. You'll be able to clean up or remove any corrupted data before finalizing your report.",
  flatfile: "Powered by ",
  header: "Here's a test line for your {{number}} {{thing}}",
  // Test line
  header2: "Here's a test line for your {{thing}}",
  // Test line
  ignored: "Ignored",
  inconvenience: "Sorry for the inconvenience. The XLS file you uploaded may be using features that make it difficult for us to extract the correct data. In order to continue, save your XLS file as a CSV and re-upload. Here are some instructions: ",
  ...
  poweredTitle: "flatfile.io makes data imports easy and secure for modern web applications",
...
var _flatfileCsvImporter = _interopRequireDefault(require("flatfile-csv-importer"));
...
_flatfileCsvImporter.default.setVersion(2);

var versaImporter = new _flatfileCsvImporter.default("4171f0b4-5f5c-4b32-a008-356ebb813e4e", // Put your license key in to show imports on your client dashboard
{
  fields: [{
    key: "code",
    ...
    label: "Artikelnummer",
    // EN - Article number
    description: "Der Code unter dem das Produkt im System geführt wird",
    // EN - The code under which the product is listed in the system
    validators: [{
      validate: "required"
    }]
  }, {
    ...
    label: "GTIN",
    // EN - GTIN
    description: "GTIN des Produkts",
    // EN - 	GTIN of the product
    validators: [{
    ...
    key: "code_of_parent",
    label: "Hauptprodukt Artikelnummer",
    // EN -  Article number Main product
    ...
    label: "Grundmengeneinheit",
    // EN - 	Basic unit of measure
    ...
    label: "Sichtbar",
    // EN - 	Visible
    description: "Soll das Produkt sichtbar sein",
    // EN - 	Should the product be visible
    type: "checkbox"
  }, {
    key: "active",
    ...
    label: "Aktiv",
    // EN - 	Active
    description: "Soll das Produkt aktiv sein",
    // EN - 	Should the product be active
    type: "checkbox"
  }, {
    key: "consider_stock",
    label: "Bestand berücksichtigen",
    // EN - 	Consider stock
    description: "Soll der Produktbestand berücksichtigt werden",
    // EN - 	Should the stock be considered	"
    type: "checkbox"
  }, {
    key: "shows_stock_amount",
    label: "Bestand anzeigen",
    // EN - 	Show stock amount
    description: "Soll der Produktbestand angezeigt werden",
    // EN - 	Should the stock amount be visible	"
    type: "checkbox"
  }, {
    key: "featured",
    ...
    label: "Top Produkt",
    // EN - 	Featured product
    description: "Ist das Produkt ein Top-Produkt",
    // EN - 	Is the product a featured product	"
    type: "checkbox"
  }, {
    key: "new",
    alternates: ["neu"],
    label: "Neues Produkt",
    // EN - 	New product
    description: "Ist das Produkt ein neues Produkt",
    // EN - 	Is the product a new product	"
    type: "checkbox"
  }, {
    key: "base_quantity",
    alternates: ["menge"],
    label: "Grundmenge",
    // EN - 	Basic quantitiy
    description: "Die Anzahl der Verpackungseinheiten in einer verpackung",
    // EN - 	The number of packaging units in a package	"
    validators: [{
      validate: "regex_matches",
      regex: "^[0-9]*$",
      error: "Must be a whole number"
    ...
    label: "Verpackungseinheit in stück",
    // EN - 	Packaging unit in pieces
    description: "Die Menge, auf die sich die Grundpreisrechnung bezieht",
    // EN - 	The quantity to which the basic price calculation refers	"
    validators: [{
      validate: "regex_matches",
      regex: "^[0-9]*$",
      error: "Must be a whole number"
    ...
    // EN - 	Packaging unit
    description: "Der Anteil der Mengeneinheit, die sich in einer Verpackung befinden",
    // EN - 	The proportion of the unit of measure that is in a package	"
    validators: [{
      validate: "regex_matches",
      regex: "^[0-9]*$",
      error: "Must be a whole number"
    ...
    label: "Grundpreisberechnung",
    // EN - 	Basic price calculation
    description: "Soll der Grundpreis berechnet werden",
    // EN - 	Should the basic price be calculated	"
    type: "checkbox"
  }, {
    key: "packaging_duration",
    alternates: ["packzeit"],
    label: "Packzeit in Stunden",
    // EN - 	Packaging duration in hours
    description: "Packzeit in Stunden",
    // EN - 	Packaging duration in hours	"
    validators: [{
      validate: "regex_matches",
      regex: "^[0-9]*$",
    ...
    key: "option_01_label",
    label: "Option_01_Bezeichnung",
    // EN - 	Option_01_Description
    description: "Bezeichnung der ersten Produkt Option",
    // EN - 	Description of the first product option	"
    validators: [{
    ...
    key: "option_02_label",
    label: "Option_02_Bezeichnung",
    // EN - 	Option_02_Description
    description: "Bezeichnung der zweiten Produkt Option",
    // EN - 	Description of the second product option
    validators: [{
      validate: "required_with",
      fields: ["option_03_label"]
    }]
  }, {
    key: "option_03_label",
    label: "Option_03_Bezeichnung",
    // EN - 	Option_03_Description
    description: "Bezeichnung der dritten Produkt Option" // EN - 	Description of the third product option

  }, {
    key: "option_01",
    label: "Option_01_Wert",
    // EN - 	Option_01_Value
    description: "Wert der ersten Produkt Option",
    // EN - 	Value of the first product option
    validators: [{
      validate: "required_with",
      fields: ["option_02", "option_03"]
    }]
  }, {
    key: "option_02",
    label: "Option_02_Wert",
    // EN - 	Option_02_Value
    description: "Wert der zweiten Produkt Option",
    // EN - 	Value of the second product option
    validators: [{
      validate: "required_with",
      fields: ["option_03"]
    }]
    ...
    label: "Bild_url_1",
    // EN - 	Image_url_1
    description: "URL des ersten Bildes",
    // EN - 	URL of the first image
    validators: [{
      validate: "required_with",
    ...
    label: "Bild_url_2",
    // EN - 	Image_url_2
    description: "URL des zweiten Bildes",
    // EN - 	URL of the second image
    validators: [{
      validate: "required_with",
      fields: ["image_url_3"],
    ...
    label: "Produktempfehlung 1 Artikelnummer",
    // EN - 	Recommended Product Article number 1
    ...
    label: "Produktempfehlung 1 Beschreibung",
    // EN - 	Recommended Product description 1
    ...
    label: "Produktempfehlung 2 Artikelnummer",
    // EN - 	Recommended Product Article number 2
    ...
    label: "Produktempfehlung 2 Beschreibung",
    // EN - 	Recommended Product description 2
    ...
    label: "Produktempfehlung 3 Artikelnummer",
    // EN - 	Recommended Product Article number 3
    ...
    label: "Produktempfehlung 3 Beschreibung",
    // EN - 	Recommended Product description 3
    description: "Beschreibung der dritten Produktempfehlung" // EN - 	Description of the third recommended product

  }],
  type: "Products",
  allowInvalidSubmit: false,
  // being set to false, the end user has to fix all the issues for the data before submitting to you all
  managed: true,
  // this gives you access to see impoorts on our dashboard
  allowCustom: true,
  // this lets your users upload a custom column that you haven't accounted for in the above fields
  disableManualInput: false,
  // this would let someone manually input the data instead of uploading a file
  i18nOverrides: {
    "en-US": _translations.translations,
    de: _translations.translations,
    en: _translations.translations
  }
}); // here is a good example column hook using our dummy API

var codes;
versaImporter.registerFieldHook("code", function (values) {
  var nonBlank = [];
  ...
  nonBlank = nonBlank.map(function (item) {
    return item[0];
  });
  codes = nonBlank;
  return [nonBlank];
});
versaImporter.registerRecordHook(function (record, index) {
  var out = {}; // below are used to make sure price is a float value without the € symbol

  if (record.price) {
    var formatCurrency = (0, _functions.makeFloat)(record.price);
    out.price = {
  ...
  if (record.compare_at_price) {
    var _formatCurrency = (0, _functions.makeFloat)(record.compare_at_price);
  ...
  if (record.weight) {
    if (!record.weight.includes(".")) {
      out.weight = {
        ...
        info: [{
          message: "formatted to a decimal",
          level: "info"
        }]
      };
    }
  ...
  if (record.code_of_parent) {
    if (!codes.includes(record.code_of_parent)) {
      out.code_of_parent = {
        info: [{
          message: "Only fill in this field if the main product already exists in your shop (or this table)",
          level: "warning"
        }]
      };
    }
...
(0, _jquery.default)("#launch").click(function () {
  versaImporter.setCustomer({
    userId: "1",
    email: "me@david.gs"
  });
  versaImporter.requestDataFromUser().then(function (results) {
    versaImporter.displaySuccess("Thanks for your data.");
  }).catch(function (error) {
    console.info(error || "window close");
  });
});
},{"flatfile-csv-importer":"node_modules/flatfile-csv-importer/build/browser/index.js","jquery":"node_modules/jquery/dist/jquery.js","./functions":"src/functions.js","./translations":"src/translations.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
